package com.bank.bian.clearingoperations.model;
...
/**
 * The BIAN control record for this service domain: "Clearing Cycle Operating Session".
 *
 ...
 * to its asset type (Clearing Cycle). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Clearing Cycle Operating Session";
